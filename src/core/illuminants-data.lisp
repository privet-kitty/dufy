...
(defparameter +illum-c+
  ;; white point is explicitly given here for backward compatibility and consistency (mainly for Munsell color conversion).
  (make-illuminant :x 0.980705971659919d0
                   :Z 1.1822494939271255d0
                   :spectrum (gen-spectrum +illum-c-arr+ 300 830)))

...
;;; (contributed by wasserwerk)
;;;


;; D55 and D75.
;;
;; Sources for white points:
;;
;; Source 1:
...
;;
;; There are some differences in the 5th decimal place. I have taken the
...
(defparameter +illum-d75+ (make-illuminant 0.29902d0 0.31485d0
					   (gen-illum-d-spectrum #.(* 7500 (/ 1.43880d0 1.438)))))
...
;;; 
;;; Source 2:
;;; https://www.hunterlab.se/wp-content/uploads/2012/11/Equivalent-White-Light-Sources-and-CIE-Illuminants.pdf
;;; 

(defparameter +illum-f1-arr+
  #.(make-array 81
...
(defparameter +illum-f1+ (make-illuminant 0.3131d0 0.3371d0
                                          (gen-spectrum +illum-f1-arr+ 380 780)))

(defparameter +illum-f2+ (make-illuminant 0.3721d0 0.3751d0
                                          (gen-spectrum +illum-f2-arr+ 380 780)))
              
(defparameter +illum-f3+ (make-illuminant 0.4091d0 0.3941d0
                                          (gen-spectrum +illum-f3-arr+ 380 780)))
              
(defparameter +illum-f4+ (make-illuminant 0.4402d0 0.4031d0
                                          (gen-spectrum +illum-f4-arr+ 380 780)))
              
(defparameter +illum-f5+ (make-illuminant 0.3138d0 0.3452d0
                                          (gen-spectrum +illum-f5-arr+ 380 780)))
              
(defparameter +illum-f6+ (make-illuminant 0.3779d0 0.3882d0
                                          (gen-spectrum +illum-f6-arr+ 380 780)))
              
(defparameter +illum-f7+ (make-illuminant 0.3129d0 0.3292d0
                                          (gen-spectrum +illum-f7-arr+ 380 780)))
              
(defparameter +illum-f8+ (make-illuminant 0.3458d0 0.3586d0
                                          (gen-spectrum +illum-f8-arr+ 380 780)))
              
(defparameter +illum-f9+ (make-illuminant 0.3741d0 0.3727d0
                                          (gen-spectrum +illum-f9-arr+ 380 780)))
              
(defparameter +illum-f10+ (make-illuminant 0.3458d0 0.3588d0
                                          (gen-spectrum +illum-f10-arr+ 380 780)))
              
(defparameter +illum-f11+ (make-illuminant 0.3805d0 0.3769d0
                                          (gen-spectrum +illum-f11-arr+ 380 780)))
              
(defparameter +illum-f12+ (make-illuminant 0.4370d0 0.4042d0
                                          (gen-spectrum +illum-f12-arr+ 380 780)))

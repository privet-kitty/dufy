...
(defun main (obj-filename)
  (let ((obj-path (merge-pathnames obj-filename this-dir-path)))
    (with-open-file (out obj-path
      ...
      (print-make-array "mrd-array-c-h" mrd-array-c-h out t)
      (print-make-array "mrd-array-c-h-dark" mrd-array-c-h-dark out t)
      (print-make-array "mrd-array-l" mrd-array-l out t)
      (print-make-array "mrd-array-l-dark" mrd-array-l-dark out t)
      (print-make-array "max-chroma-arr" max-chroma-arr out t)
      (print-make-array "max-chroma-arr-dark" max-chroma-arr-dark out t))

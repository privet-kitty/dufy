...
space."
  ...
  (let* ((radius (round (/ size 2)))
    ...
    (labels ((polar-to-cartesian (c h)
               (let ((h-rad (mod (* h dufy/core::+TWO-PI/360+) dufy/core::TWO-PI))
                              ...
                              (multiple-value-bind (x1-offseted y1-offseted)
                                ...
                                (multiple-value-bind (x2-offseted y2-offseted)
                                  ...
                                  (unless (and (<= (abs x1-offseted) radius)
                                    ...
                                    (loop-finish))
                                  (sdl:draw-line-* (round (+ center-x x1-offseted))
                                                   (round (+ center-y y1-offseted))
                                                   (round (+ center-x x2-offseted))
                                                   (round (+ center-y y2-offseted))

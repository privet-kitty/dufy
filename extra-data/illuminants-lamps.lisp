;;;
;;; Illuminants data of several gas-discharge lamps
;;; (based on "Measuring Color" 4th edition by R. W. G. Hunt and M. R. Pointer)
;;;

(uiop:define-package :dufy/extra-data/illuminants-lamps
  (:use :cl :dufy/core/*)
  (:export #:+illum-sox+
           #:+illum-hp1+
           #:+illum-hp2+
...
(in-package :dufy/extra-data/illuminants-lamps)

(eval-when (:compile-toplevel :load-toplevel :execute)
  (defparameter +illum-sox-table+
    (make-array 81
  ...
  (defparameter +illum-xenon-table+
    (make-array 81
                :element-type 'double-float
...
(defparameter +illum-sox+
  (make-illuminant :spectrum (gen-spectrum +illum-sox-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "Low pressure sodium lamp SOX")
(defparameter +illum-hp1+
  (make-illuminant :spectrum (gen-spectrum +illum-hp1-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "Standard high pressure sodium lamp HP1")
(defparameter +illum-hp2+
  (make-illuminant :spectrum (gen-spectrum +illum-hp2-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "Color enhanced high pressure sodium lamp HP2")
(defparameter +illum-mb+
  (make-illuminant :spectrum (gen-spectrum +illum-mb-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "High pressure mercury lamp type MB")
(defparameter +illum-mbf+
  (make-illuminant :spectrum (gen-spectrum +illum-mbf-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "High pressure mercury lamp type MBF")
(defparameter +illum-mbtf+
  (make-illuminant :spectrum (gen-spectrum +illum-mbtf-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "High pressure mercury lamp type MBTF")
(defparameter +illum-hmi+
  (make-illuminant :spectrum (gen-spectrum +illum-hmi-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "High pressure mercury lamp type HMI")
(defparameter +illum-xenon+
  (make-illuminant :spectrum (gen-spectrum +illum-xenon-table+ 380 780)
                   :begin-wl 380 :end-wl 780
                   :compile-time t)
  "Xenon lamp")

...
(uiop:define-package :dufy/core/illuminants-data
  (:use :cl :dufy/internal/* :dufy/core/spectrum)
  (:export #:+illum-a+ #:+illum-c+ #:+illum-e+ #:+illum-d50+ #:+illum-d65+))

(in-package :dufy/core/illuminants-data)
...
;; such calculated white points are (close to) already frequently used
;; ones for these illuminants.
;;

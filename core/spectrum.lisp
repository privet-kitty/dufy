;;;
;;; Spectrum, Observer, and Illuminant
;;;

(uiop:define-package :dufy/core/spectrum
  (:use :cl :alexandria :dufy/internal/* :dufy/core/cmf-data)
  (:export #:spectrum
           #:gen-spectrum
...
number as a wavelength (nm) and returns a double-float. The ftype
is (function * (values double-float &optional))")
...
;; See http://www.rit.edu/cos/colorscience/rc_useful_data.php
...
is true, the temperature multiplied by 1.4388/1.438 is used
